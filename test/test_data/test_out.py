...
class TestOutDataIntegration:
    ...
    def test_fragment_to_particle_hierarchy(self):
        ...
        fragments = [
            RecoFragment(
                id=0, particle_id=5, shape=1, is_primary=True, size=200, length=45.0
            ),
            RecoFragment(
                id=1,
                particle_id=5,
    ...
    def test_truth_reco_matching(self):
        ...
        pos_diff = np.linalg.norm(
            truth_fragment.start_point - reco_fragment.start_point
        )
    ...
    def test_complete_event_reconstruction(self):
        ...
        truth_interaction = TruthInteraction(
            id=0,
            vertex=np.array([15.0, 20.0, 100.0]),
            size=1000,
        )
        ...
        reco_interaction = RecoInteraction(
            id=0,
            vertex=np.array([15.2, 20.1, 99.8]),  # Close vertex
            size=800,
            # Matching information
            is_matched=True,
