...
class CollateAll:
    ...
    def __init__(self, data_types, split=False, target_id=0, detector=None,
                 geometry_file=None, source=None, overlay=None,
    ...
    def stack_coord_tensors(self, batch, key):
        ...
        if not self.split:
            ...
            batch_ids = np.repeat(
                    np.arange(batch_size, dtype=coords.dtype), counts)
