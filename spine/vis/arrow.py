...
def scatter_arrows(points, directions, length=10.0, tip_ratio=0.25, color=None,
    ...
    traces = scatter_points(
            vertices, color=color_trunks, hovertext=hovertext_trunks,
            line=line, linewidth=linewidth, mode='lines',
            hovertemplate='%{text}', name=name, legendgroup=legendgroup)
    ...
    traces += [go.Cone(
            ...
            showscale=False, showlegend=False, sizemode='raw',
            colorscale=colorscale, hovertext=hovertext_arrows,
            hovertemplate='%{hovertext}', name=name, legendgroup=legendgroup)]
