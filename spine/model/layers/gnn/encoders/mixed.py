...
See :mod:`spine.model.layers.gnn.encoders.geometric` and
:mod:`spine.model.layers.gnn.encoders.cnn` for more information.
"""

import torch

from spine.model.layers.common.act_norm import act_factory
