"""Particle truth-information helpers for LArCV parsers.
...
# The event adapter materializes each derived truth-label array explicitly.
...
# Neutrino ownership supports several generations of LArCV truth conventions.
