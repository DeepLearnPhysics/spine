...
export LARCV_BUILDDIR="${LARCV_BUILDDIR:-${LARCV_BASEDIR}/build}"
export LARCV_LIBDIR="${LARCV_LIBDIR:-${LARCV_BASEDIR}/build/lib}"
export LARCV_PYTHONDIR="${LARCV_PYTHONDIR:-${LARCV_BASEDIR}/python}"
export LARCV_INCDIR="${LARCV_INCDIR:-${LARCV_BASEDIR}/build/include}"
export LARCV_BINDIR="${LARCV_BINDIR:-${LARCV_BASEDIR}/build/bin}"
export LARCV_COREDIR="${LARCV_COREDIR:-${LARCV_BASEDIR}/larcv/core}"
export LARCV_APPDIR="${LARCV_APPDIR:-${LARCV_BASEDIR}/larcv/app}"
export LARCV_NUMPY="${LARCV_NUMPY:-1}"
export LARCV_OPENCV="${LARCV_OPENCV:-1}"
export LARCV_ROOT6="${LARCV_ROOT6:-1}"
...
_spine_prepend_path PATH "${LARCV_BINDIR}"
