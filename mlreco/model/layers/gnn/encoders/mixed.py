...
See :mod:`mlreco.model.layers.gnn.encoders.geometric` and
:mod:`mlreco.model.layers.gnn.encoders.cnn` for more information.
"""

import torch

from mlreco.model.layers.common.act_norm import act_factory
