...
from mlreco.model.uresnet import SegmentationLoss
from collections import defaultdict
from mlreco.model.uresnet import UResNetSegmentation
from mlreco.model.layers.cnn.vertex_ppn import VertexPPN, VertexPPNLoss
from mlreco.model.experimental.layers.pointnet import PointNetEncoder
...
class UResNetVertexLoss(nn.Module):
    ...
    See Also
    --------
    mlreco.model.uresnet.SegmentationLoss, mlreco.model.layers.common.ppn.PPNLonelyLoss
    """
    def __init__(self, cfg):
