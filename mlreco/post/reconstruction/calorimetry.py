"""Groups post-processors associated with calorimetric reconstruction."""

import numpy as np

from mlreco.utils.globals import TRACK_SHP

from mlreco.post.base import PostBase
...
class CalorimetricEnergyProcessor(PostBase):
    ...
    def __init__(self, ADC_to_MeV=1., shower_fudge=1., run_mode='reco'):
